...
class MazeWorld extends World {
    ...
    public WorldScene makeScene() {
        WorldScene w = new WorldScene(Cell.SIZE * (this.WIDTH + 1), 
                Cell.SIZE * (this.HEIGHT + 1));
        for (Edge e : walls) {
            w.placeImageXY(e.drawEdge(), ((e.c1.x + e.c2.x) / 2 + 1/2) * Cell.SIZE, 
                    ((e.c1.y + e.c2.y) / 2 + 1/2) * Cell.SIZE);
        }
        return w;
